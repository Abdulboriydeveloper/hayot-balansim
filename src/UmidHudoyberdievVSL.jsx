...
function InstaBadge() {
  return (
    <a href="https://www.instagram.com/umidhudoyberdiev" target="_blank" rel="noopener noreferrer" className="sm-insta-badge">
    ...
    <section className="sm-hero">
      ...
      <div className="sm-sec-title-wrap">
        <p className="sm-sec-title">
          Ro'yxatdan o'tish orqali <span className="red">qo'lga kiritasiz:</span>
        </p>
      </div>
    </section>
  );
      ...
      <div className="sm-author-inner">
        ...
        <div className="sm-author-body">
          <div className="sm-creds">
            {CREDS.map((c, i) => (
              <div key={i} className={`sm-cred ${c.gold ? "sm-cred-g" : "sm-cred-w"}`}>{c.t}</div>
            ))}
          </div>
